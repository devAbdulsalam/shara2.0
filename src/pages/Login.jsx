      ...
      <section className="p-5 py-8 w-full ">
          ...
          <div className="mx-auto p-4 md:p-0 w-full md:min-w-[700px] md:max-w-[800px] mt-10 md:mt-20 shadow-xl rounded-lg md:rounded-xl md:flex bg-white md:bg-green-500">
            ...
            <div className="md:w-7/12 mb-0 mx-0 flex flex-col py-4 md:py-10 md:px-20 bg-white">
              <h2 className="text-green-500 text-2xl text-center font-bold">Log in</h2>
              <form className="w-full m-0 flex flex-col py-4" onSubmit={handleSubmit}>
                ...
                <div className="flex justify-between sm:text-sm  my-4 items-center text-gray-600">
                  ...
                  <Link to={'/forgetPassword'} className="text-sm text-green-700 hover:text-green-600">Forget Password</Link>
                </div>
                <p className="py-2 text-gray-600 text-lg">
                    New to Shara? 
                    <Link to={'/signup'} className="text-green-700 hover:text-green-600"> Sign up</Link> 
                </p>
              </form>
            </div>
          </div>
