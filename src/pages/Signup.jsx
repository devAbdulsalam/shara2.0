            ...
            <div className="hidden md:flex items-center justify-center flex-col w-5/12">
              ...
              <h1 className="text-white text-2xl font-bold my-4">WELCOME BACK</h1>
                <button className={`font-semibold text-3xl  rounded-md mt-4 p-3 shadow-xl bg-gray-50 justify-center flex  ${showSignUp ? 'border-b-4 border-green-600 text-green-600' : "text-green-700"}`} onClick={handleSignUp}>
                  ...
                  <span className="text-green-600 text-xl px-2 font-semibold">Log in</span>
                </button>
            </div>
            <div className="md:w-7/12 mb-0 mx-0 flex flex-col py-4 md:py-10 md:px-20 bg-white">
              <h2 className="text-green-500 text-2xl text-center font-bold">Sign up</h2>
              <form className="w-full flex flex-col py-4" onSubmit={handleSubmit}>
                ...
                <div className='mt-2'>
                  ...
                  <button type="submit" className="bg-[#228e01] w-full text-white py-3 my-6 rounded font-bold" disabled={isLoading}>
                    Sign in
                  </button>
                ...
                <div className="flex justify-between sm:text-sm text-lg my-6 items-center text-gray-600">
                  ...
                  <Link to={'/forgetPassword'} className="text-lg text-green-700 hover:text-green-600">Forget Password</Link>
                </div>
